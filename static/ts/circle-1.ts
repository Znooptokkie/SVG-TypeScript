...
function firstFilterElement(): void 
{
...
function secondFilterElement(): void 
{
...
function groupWhiteHollowFirst(): void // TODO: Worden 2 identieke functions. Dus misschien een class maken ervan?
{
...
function groupWhiteHollowSecond(): void // TODO: Worden 2 identieke functions. Dus misschien een class maken ervan?
{
    const firstGroup = new SVGGroup(firstPrototypeSVG, 
    {
...
function groupSmallBorders(): void
{
    const firstGroup = new SVGGroup(firstPrototypeSVG, 
    {
        class: "small-borders"
...
function groupInnerBorders(): void
{
    const firstGroup = new SVGGroup(firstPrototypeSVG, 
    {
        class: "inner-borders"
...
function groupMiddleBorders(): void
{
    const firstGroup = new SVGGroup(firstPrototypeSVG, 
    {
...
const radiusFirstRow: number = 400;
const circumferenceInnerBorder: number = CalcCircleProperties.calcCircleCircumference(radiusFirstRow); 

const radiusFirstRowBG: number = 430;
const circumferenceInnerBorderBG: number = CalcCircleProperties.calcCircleCircumference(radiusFirstRowBG); 

const radiusSecondRow: number = 435;
const circumferenceMiddleBorder: number = CalcCircleProperties.calcCircleCircumference(radiusSecondRow); 

const radiusSecondRowBG: number = 465;
const circumferenceMiddleBorderBG: number = CalcCircleProperties.calcCircleCircumference(radiusSecondRowBG); 
...
const firstPrototypeSVG = new CreateSvgElements(
    "proto-1",
    {
